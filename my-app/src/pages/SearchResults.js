  ...
  const CustomDropdown = ({ id, title, options, selectedValue, onSelect, placeholder, isPrice }) => {
    return (
      <Dropdown as={InputGroup.Prepend} alignRight>
        ...
        <Dropdown.Menu>
          {isPrice && (
            <FormControl autoFocus placeholder={placeholder} className="mx-3 my-2 w-auto" onChange={(e) => onSelect(e.target.value)} style={{ width: "95%" }} />
          )}
...
function SearchResults() {
  ...
  const search = () => {
    ...
    const filteredListings = houseInfo.filter((listing) => {
      ...
      return price >= minPriceValue && price <= maxPriceValue && listingBedrooms >= bedroomsValue && listingBathrooms >= bathroomsValue;
    });
  ...
  return (
    <div style={{ height: "100vh", background: "linear-gradient(rgba(16, 166, 144, 0.5), white)" }}>
      ...
      <Navbar expand="lg" className="bg-white">
        <Container>
          <InputGroup>
            <FormControl placeholder="City, Neighbourhood, Address or MLS number" aria-label="Search" className="me-2" />
            {/* Min Price Dropdown */}
            <Dropdown>
              <Dropdown.Toggle variant="outline-secondary" id="dropdown-min-price">
                Min Price: {minPrice}
              </Dropdown.Toggle>
              <Dropdown.Menu style={{ transform: "translateX(562px)" }}>
                <FormControl
                  autoFocus
            ...
            <Dropdown as={InputGroup.Append}>
              ...
              <Dropdown.Menu style={{ transform: "translateX(678px)" }}>
                <FormControl
                  autoFocus
            ...
            <Dropdown as={InputGroup.Append}>
              ...
              <Dropdown.Menu style={{ transform: "translateX(897px)" }}>
            ...
            <Dropdown as={InputGroup.Append}>
              ...
              <Dropdown.Menu style={{ transform: "translateX(1039px)" }}>
                {bedBathOptions.map((option, index) => (
            ...
            <Modal.Body>
              <Form style={{ overflowY: "auto", maxHeight: "100%" }}>
                ...
                <Form.Group controlId="noiseLevel">
                  ...
                  <Form.Select aria-label="Noise Level" onChange={(e) => setNoiseLevel(e.target.value)} value={noiseLevel}>
                ...
                <Form.Group controlId="pool">
                  ...
                  <Form.Select aria-label="Pool" onChange={(e) => setPool(e.target.value)} value={pool}>
          ...
          <Row className="no-gutters content-row">
            ...
            <Col md={6} className="map-column">
              <div className="flex-row d-flex">
                <Button onClick={handleResetMap} style={{ margin: "10px", width: "50%" }}>
                  Reset Map View
                </Button>
                <Button onClick={handleViewHouse} style={{ margin: "10px", width: "50%" }}>
                  View House Details
                </Button>
              </div>
